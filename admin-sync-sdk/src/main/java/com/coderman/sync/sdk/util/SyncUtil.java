package com.coderman.sync.sdk.util;
...
import com.coderman.sync.sdk.constant.Constant;
import com.coderman.sync.sdk.producer.ActiveMQProducer;
import com.coderman.sync.sdk.vo.MsgBody;
import com.coderman.sync.sdk.vo.MsgItem;
import com.coderman.sync.sdk.vo.PlanMsg;
...
public class SyncUtil {
    ...
    private static void sendMsgBySql(MsgBody msgBody) {
        ...
        try {
            ...
            if (null != sendResult) {
                ...
                mid = sendResult.getJMSMessageID();
            }
    ...
    public static String createMsg(PlanMsg planMsg, String createTime, String msgId) {
        ...
        for (int i = 0; i < planMsg.getMsgItemList().size(); i++) {
            ...
            MsgItem msgItem = planMsg.getMsgItemList().get(i);
